% common arguments
\newcommand{\coursenum}[0]{CSCI 0321}%
\newcommand{\coursetitletop}[0]{Bioinformatics}%
\newcommand{\coursetitlebottom}[0]{Algorithms}%
...
\begin{tikzpicture}
  ...
  \node[]             at   (0.0, 0)     {\includegraphics[height=0.8 in]{DNA.pdf}};
