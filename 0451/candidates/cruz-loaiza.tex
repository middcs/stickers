% common arguments
\newcommand{\coursenum}[0]{CSCI 0451}%
\newcommand{\coursetitletop}[0]{Machine Learning}%
\newcommand{\coursetitlebottom}[0]{}%
\newcommand{\bordercolor}[0]{5C6C85}%
...
\begin{tikzpicture}
  ...
  \node[]             at   (0.1, 0)     {\includegraphics[height=0.9 in]{grossman.png}};
