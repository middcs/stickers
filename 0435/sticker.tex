% common arguments
\newcommand{\coursenum}[0]{CSCI 0435}%
\newcommand{\coursetitletop}[0]{Embedded}%
\newcommand{\coursetitlebottom}[0]{Systems}%
...
\begin{tikzpicture}
  ...
  \node[]             at   (0.1, 0)     {\includegraphics[height=0.8 in]{chip+ports.png}};
