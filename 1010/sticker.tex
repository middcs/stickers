% common arguments
\newcommand{\coursenum}[0]{CSCI 1010}%
\newcommand{\coursetitletop}[0]{Applied Data}%
\newcommand{\coursetitlebottom}[0]{Science}%
...
\begin{tikzpicture}
  ...
  \node[]             at   (0.0, 0)     {\includegraphics[height=0.8in]{corgi.pdf}};
