% common arguments
\newcommand{\coursenum}[0]{CSCI 0200}%
\newcommand{\coursetitletop}[0]{Math Foundations}%
\newcommand{\coursetitlebottom}[0]{}%
\newcommand{\bordercolor}[0]{91CC79}%
...
\begin{tikzpicture}
  ...
  \node[]             at   (0.0, 0)     {\includegraphics[height=0.8 in]{cat.jpg}};
